        ...
        if (function_exists('the_champ_login_button')) {
            ...
            public function commentRowStickAction($actions, $comment) {
                if (!$comment->comment_parent) {
                    ...
                    $actions['close'] = '<a data-comment="' . $comment->comment_ID . '" data-post="' . $comment->comment_post_ID . '" class="wc_close_btn" href="#"> <i class="fa ' . $closeIcon . '"></i> <span class="wc_close_text">' . $closeText . '</span></a>';
                }
                return $actions;
            }
