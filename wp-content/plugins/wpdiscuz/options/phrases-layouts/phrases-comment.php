    ...
    <table class="wp-list-table widefat plugins"  style="margin-top:10px; border:none;">
        <tbody>
            ...
            <tr valign="top">
                ...
                <td colspan="3"><input type="text" value="<?php echo isset($this->optionsSerialized->phrases['wc_close_main_form_comment_on']) ? $this->optionsSerialized->phrases['wc_close_main_form_comment_on'] : __('Close this comment - (on)', 'wpdisucz'); ?>" name="wc_close_main_form_comment_on" id="wc_close_main_form_comment_on" /></td>
            </tr>
            <tr valign="top">
                <th scope="row"><label for="wc_close_main_form_comment_off"><?php _e('Close this comment - (off)', 'wpdiscuz'); ?></label></th>
                <td colspan="3"><input type="text" value="<?php echo isset($this->optionsSerialized->phrases['wc_close_main_form_comment_off']) ? $this->optionsSerialized->phrases['wc_close_main_form_comment_off'] : __('Close this comment - (off)', 'wpdisucz'); ?>" name="wc_close_main_form_comment_off" id="wc_close_main_form_comment_off" /></td>
            </tr>
            <tr valign="top">
                <th scope="row"><label for="wc_close_comment"><?php _e('Close', 'wpdiscuz'); ?></label></th>
                <td colspan="3"><input type="text" value="<?php echo isset($this->optionsSerialized->phrases['wc_close_comment']) ? $this->optionsSerialized->phrases['wc_close_comment'] : __('Close', 'wpdisucz'); ?>" name="wc_close_comment" id="wc_close_comment" /></td>
            </tr>
            <tr valign="top">
                <th scope="row"><label for="wc_open_comment"><?php _e('Open', 'wpdiscuz'); ?></label></th>
                <td colspan="3"><input type="text" value="<?php echo isset($this->optionsSerialized->phrases['wc_open_comment']) ? $this->optionsSerialized->phrases['wc_open_comment'] : __('Open', 'wpdisucz'); ?>" name="wc_open_comment" id="wc_open_comment" /></td>
            </tr>
            <tr valign="top">
                <th scope="row"><label for="wc_closed_comment_icon_title"><?php _e('Closed comment icon title', 'wpdiscuz'); ?></label></th>
                <td colspan="3"><input type="text" value="<?php echo isset($this->optionsSerialized->phrases['wc_closed_comment_icon_title']) ? $this->optionsSerialized->phrases['wc_closed_comment_icon_title'] : __('Closed comment thread', 'wpdisucz'); ?>" name="wc_closed_comment_icon_title" id="wc_closed_comment_icon_title" /></td>
            </tr>
