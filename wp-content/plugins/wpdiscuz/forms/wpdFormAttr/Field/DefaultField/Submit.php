                ...
                if ($isShowSubscribeWrapper) {
                    ...
                    if ($isMainForm && current_user_can('moderate_comments')) {
                        ...
                        <label class="wpd_label">
                            ...
                            <span class="wpd_label__text">
                                <span class="wpd_label__check">
                                    <div class="wpd-field-desc"><i class="fa fa-lock wpdicon wpdicon-on"></i><span><?php echo $options->phrases['wc_close_main_form_comment_on']; ?></span></div>
                                    <div class="wpd-field-desc"><i class="fa fa-unlock-alt wpdicon wpdicon-off"></i><span><?php echo $options->phrases['wc_close_main_form_comment_off']; ?></span></div>
                                </span>
                            </span>
                        </label>
                        <?php
